...
async function handleRegister(e) {
    ...
    const { data, error } = await supabaseClient.auth.signUp({
        ...
        options: {
            data: {
                name: name // Passa o nome para o trigger usar
            }
        }
    });
...
// ======================================================
// Funções restantes (ainda usando localStorage por enquanto)
// ======================================================
